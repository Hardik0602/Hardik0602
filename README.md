...
🚀 I'm a Frontend Developer with experience in **React.js** and **React Native**, focused on building modern and responsive applications.

🎯 My goal is to become a Software Developer and create solutions that deliver both **exceptional performance** and **great user experience**.
...
💻 I'm passionate about building real-world applications with **clean UI** and **practical use cases** using tools from my tech stack.

🤝 I'm open to collaborating on projects that align with my tech stack and help me grow as a developer.
